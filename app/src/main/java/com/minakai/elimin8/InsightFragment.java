 ...
 * {@link InsightFragmentListener} interface
...
public class InsightFragment extends Fragment {
    ...
    private InsightFragmentListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onInsightInputSent(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof InsightFragmentListener) {
            mListener = (InsightFragmentListener) context;
        } else {
     ...
     */
    public interface InsightFragmentListener {
        // TODO: Update argument type and name
        void onInsightInputSent(Uri uri);
    }
}
